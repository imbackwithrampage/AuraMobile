package com.aura.app.core.sync
...
import com.aura.app.core.time.EpisodeReleaseDatePlatform
import com.aura.app.features.addons.AddonRepository
import com.aura.app.features.collection.CollectionSyncService
import com.aura.app.features.home.HomeCatalogSettingsSyncService
...
private const val PERIODIC_AURA_SYNC_PULL_INTERVAL_MS = 15 * 60_000L
...
object SyncManager {
    ...
    fun startPeriodicNuvioSyncPull(profileId: Int) {
        ...
        periodicNuvioSyncPullJob = accountScopeSnapshot().launch {
            while (isActive) {
                delay(PERIODIC_AURA_SYNC_PULL_INTERVAL_MS)
