...
import com.aura.app.features.tracking.trackingMembershipDestinations
...
import aura.composeapp.generated.resources.compose_tracking_list_picker_loading
import aura.composeapp.generated.resources.compose_tracking_list_picker_subtitle
            ...
            Column(
                ...
                if (isPending && destinations.isEmpty()) {
                    Box(
                        modifier = Modifier
                            .fillMaxWidth()
                            .height(AuraTokens.Space.s80 + AuraTokens.Space.s80 + AuraTokens.Space.s80 + AuraTokens.Space.s40),
                        ...
                        items(items = destinations, key = { it.key }) { tab ->
                            ...
                            Row(
                                modifier = Modifier
                                    ...
                                    .padding(horizontal = AuraTokens.Space.s14, vertical = tokens.spacing.listGap),
