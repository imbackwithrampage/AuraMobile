...
import com.aura.app.core.network.ServerDiscoveryFailure
...
import aura.composeapp.generated.resources.server_connect_action
import aura.composeapp.generated.resources.server_connect_checking
import aura.composeapp.generated.resources.server_connect_subtitle
import aura.composeapp.generated.resources.server_connect_title
import aura.composeapp.generated.resources.server_connect_url_placeholder
import aura.composeapp.generated.resources.server_error_auth
import aura.composeapp.generated.resources.server_error_connection
import aura.composeapp.generated.resources.server_error_http
import aura.composeapp.generated.resources.server_error_invalid_document
import aura.composeapp.generated.resources.server_error_invalid_url
import aura.composeapp.generated.resources.server_error_missing_configuration
import aura.composeapp.generated.resources.server_error_not_self_hosted
import aura.composeapp.generated.resources.server_error_official_active
import aura.composeapp.generated.resources.server_error_official_available
import aura.composeapp.generated.resources.server_error_response_too_large
import aura.composeapp.generated.resources.server_error_restart
import aura.composeapp.generated.resources.server_error_save
import aura.composeapp.generated.resources.server_error_session_clear
import aura.composeapp.generated.resources.server_error_service
import aura.composeapp.generated.resources.server_error_version
import aura.composeapp.generated.resources.server_menu_change_custom
import aura.composeapp.generated.resources.server_menu_content_description
import aura.composeapp.generated.resources.server_menu_custom
import aura.composeapp.generated.resources.server_menu_official
import aura.composeapp.generated.resources.server_official_action
import aura.composeapp.generated.resources.server_official_body
import aura.composeapp.generated.resources.server_official_title
import aura.composeapp.generated.resources.server_review_description
import aura.composeapp.generated.resources.server_review_key_discovered
import aura.composeapp.generated.resources.server_review_key_label
import aura.composeapp.generated.resources.server_review_title
import aura.composeapp.generated.resources.server_review_trust
import aura.composeapp.generated.resources.server_review_verified_label
import aura.composeapp.generated.resources.server_switching
import aura.composeapp.generated.resources.server_warning_credentials
import aura.composeapp.generated.resources.server_warning_http
import aura.composeapp.generated.resources.server_warning_private
import aura.composeapp.generated.resources.server_warning_public
import aura.composeapp.generated.resources.server_warning_public_http
import aura.composeapp.generated.resources.server_warning_title
...
internal fun ServerConnectionSheet(
    ...
    NuvioModalBottomSheet(
        ...
        Column(
            ...
            Spacer(modifier = Modifier.height(AuraTokens.Space.s8))
            Text(
                text = stringResource(Res.string.server_connect_subtitle),
                style = MaterialTheme.typography.bodyMedium,
                color = tokens.colors.textMuted,
            )
            Spacer(modifier = Modifier.height(AuraTokens.Space.s20))
            OutlinedTextField(
                value = url,
            ...
            if (error != null) {
                Spacer(modifier = Modifier.height(AuraTokens.Space.s10))
                Text(
                    text = error,
            ...
            Button(
                ...
                if (state.isDiscovering) {
                    Row(
                        horizontalArrangement = Arrangement.spacedBy(AuraTokens.Space.s8),
    ...
    BasicAlertDialog(onDismissRequest = { if (!isSwitching) onDismiss() }) {
        Surface(
            ...
            Column(
                ...
                Spacer(modifier = Modifier.height(AuraTokens.Space.s16))
                ServerDetail(
                ...
                Column(
                    modifier = Modifier
                        ...
                        .background(
                            ...
                            shape = RoundedCornerShape(AuraTokens.Radius.lg),
                        )
                        .padding(AuraTokens.Space.s14),
                    verticalArrangement = Arrangement.spacedBy(AuraTokens.Space.s8),
                ) {
                    Text(
...
private fun ServerDetail(
    ...
    Column(
        modifier = Modifier
            ...
            .padding(AuraTokens.Space.s14),
        verticalArrangement = Arrangement.spacedBy(AuraTokens.Space.s4),
    ) {
        Text(
            text = label,
...
private fun DialogActions(
    ...
    Row(
        modifier = Modifier.fillMaxWidth(),
        horizontalArrangement = Arrangement.spacedBy(AuraTokens.Space.s10, Alignment.End),
    ) {
        Button(
            onClick = onDismiss,
            enabled = !isSwitching,
