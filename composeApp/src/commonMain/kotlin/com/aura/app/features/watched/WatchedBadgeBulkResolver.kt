...
import com.aura.app.features.simkl.toSimklShowIdSiblings
...
import com.aura.app.features.trakt.TraktProgressRepository
...
private fun getActiveProviderSiblingMap(): Map<String, Set<String>> {
    ...
    val effectiveSource = effectiveWatchProgressSource(
        ...
        isProviderAuthenticated = { providerId ->
            com.aura.app.features.tracking.TrackingProviderRegistry.isAuthenticated(providerId)
        },
    )
