package com.aura.app.features.cloud

import com.aura.app.features.debrid.DebridProviders
import com.aura.app.features.debrid.TorboxApiClient
import com.aura.app.features.debrid.TorboxCloudFileDto
import com.aura.app.features.debrid.TorboxCloudItemDto
...
internal class TorboxCloudLibraryProviderApi : CloudLibraryProviderApi {
    ...
    private fun com.aura.app.features.debrid.DebridApiResponse<com.aura.app.features.debrid.TorboxEnvelopeDto<List<TorboxCloudItemDto>>>.itemsOrThrow(
...
internal fun com.aura.app.features.debrid.DebridApiResponse<com.aura.app.features.debrid.TorboxEnvelopeDto<List<TorboxCloudItemDto>>>.toCloudLibraryItemsOrThrow(
    providerId: String,
    providerName: String,
    type: CloudLibraryItemType,
): List<CloudLibraryItem> {
