...
import com.aura.app.features.cloud.cloudLibraryProviderPosterUrl
import com.aura.app.features.details.MetaVideo
import com.aura.app.features.tracking.TrackingAttributedItem
...
data class WatchProgressUiState(
    val source: WatchProgressSource = WatchProgressSource.AURA_SYNC,
...
): String = com.aura.app.features.watching.domain.buildPlaybackVideoId(
