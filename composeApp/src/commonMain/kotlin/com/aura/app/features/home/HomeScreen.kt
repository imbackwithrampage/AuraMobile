...
import com.aura.app.core.ui.LocalNuvioBottomNavigationOverlayPadding
import com.aura.app.core.ui.NuvioScreen
import com.aura.app.core.ui.NuvioNetworkOfflineCard
import com.aura.app.core.ui.nuvioSafeBottomPadding
import com.aura.app.core.ui.rememberHeroStretchState
import com.aura.app.core.ui.rememberPosterCardStyleUiState
import com.aura.app.core.ui.withDuplicateSafeLazyKeys
import com.aura.app.features.addons.AddonRepository
import com.aura.app.features.addons.enabledAddons
import com.aura.app.features.cloud.CloudLibraryContentType
import com.aura.app.features.cloud.CloudLibraryRepository
import com.aura.app.features.cloud.CloudLibraryUiState
import com.aura.app.features.cloud.findPlaybackTargetForProgress
import com.aura.app.features.details.MetaDetails
import com.aura.app.features.details.MetaDetailsRepository
import com.aura.app.features.details.MetaVideo
import com.aura.app.features.details.SeriesPrimaryAction
import com.aura.app.features.details.seriesPrimaryAction
import com.aura.app.features.home.components.HomeCatalogRowSection
import com.aura.app.features.home.components.HomeContinueWatchingSection
import com.aura.app.features.home.components.HomeEmptyStateCard
import com.aura.app.features.home.components.HomeHeroReservedSpace
import com.aura.app.features.home.components.HomeHeroSection
import com.aura.app.features.home.components.HomeSkeletonHero
import com.aura.app.features.home.components.HomeSkeletonRow
import com.aura.app.features.home.components.HomeContinueWatchingSectionBottomPadding
import com.aura.app.features.home.components.ContinueWatchingLayout
...
import com.aura.app.features.watched.WatchedItem
import com.aura.app.features.watched.WatchedRepository
import com.aura.app.features.watched.episodePlaybackId
import com.aura.app.features.watched.resolveWatchedBadgesBulk
import com.aura.app.features.watched.watchedItemKey
import com.aura.app.features.watchprogress.CachedInProgressItem
import com.aura.app.features.watchprogress.CachedNextUpItem
import com.aura.app.features.watchprogress.ContinueWatchingEnrichmentCache
import com.aura.app.features.watchprogress.CurrentDateProvider
import com.aura.app.features.watchprogress.ContinueWatchingPreferencesRepository
import com.aura.app.features.watchprogress.ContinueWatchingPreferencesUiState
import com.aura.app.features.watchprogress.ContinueWatchingItem
import com.aura.app.features.watchprogress.ContinueWatchingSortMode
import com.aura.app.features.watchprogress.isMalformedNextUpSeedContentId
import com.aura.app.features.watchprogress.isSeriesTypeForContinueWatching
import com.aura.app.features.watchprogress.nextUpDismissKey
import com.aura.app.features.watchprogress.parseReleaseDateToEpochMs
import com.aura.app.features.watchprogress.resolvedProgressKey
import com.aura.app.features.watchprogress.shouldTreatAsInProgressForContinueWatching
import com.aura.app.features.watchprogress.shouldUseAsCompletedSeedForContinueWatching
import com.aura.app.features.watchprogress.WatchProgressClock
import com.aura.app.features.watchprogress.WatchProgressEntry
...
import com.aura.app.features.watchprogress.buildContinueWatchingEpisodeSubtitle
import com.aura.app.features.watchprogress.continueWatchingEntries
import com.aura.app.features.watchprogress.toContinueWatchingItem
import com.aura.app.features.watchprogress.toUpNextContinueWatchingItem
import com.aura.app.core.ui.DisintegrationRequest
import com.aura.app.features.watching.application.WatchingState
import com.aura.app.features.watching.domain.WatchingContentRef
import com.aura.app.features.watching.domain.isReleasedBy
import com.aura.app.features.collection.CollectionRepository
import com.aura.app.features.profiles.ProfileRepository
import com.aura.app.features.home.components.HomeCollectionRowSection
...
import com.aura.app.features.home.components.continueWatchingHeroViewportReserveHeight
import com.aura.app.features.home.components.homeSectionHorizontalPaddingForWidth
import com.aura.app.features.home.components.rememberContinueWatchingLayout
    ...
    val cachedNextUpItems = remember(
        ...
        cachedSnapshots.first.mapNotNull { cached ->
            ...
            val sortTimestamp = if (item.isReleaseAlert) {
                com.aura.app.features.watchprogress.parseReleaseDateToEpochMs(item.released) ?: cached.lastWatched
            } else {
                cached.lastWatched
            }
...
internal fun cachedNextUpHasAired(
    ...
    com.aura.app.features.watchprogress.parseReleaseDateToEpochMs(cached.released)
...
private suspend fun resolveHomeNextUpCandidate(
    ...
    val sortTimestamp = if (item.isReleaseAlert) {
        com.aura.app.features.watchprogress.parseReleaseDateToEpochMs(item.released) ?: completedEntry.markedAtEpochMs
    } else {
...
private fun MetaDetails.videoForSeriesAction(action: SeriesPrimaryAction): MetaVideo? {
    ...
    return videos.firstOrNull { video ->
        com.aura.app.features.watchprogress.buildPlaybackVideoId(
            parentMetaId = id,
...
private fun CompletedSeriesCandidate.toContinueWatchingSeed(meta: com.aura.app.features.details.MetaDetails) =
    WatchProgressEntry(
...
private fun CachedNextUpItem.toContinueWatchingItem(): ContinueWatchingItem? {
    val alertState = com.aura.app.features.watchprogress.calculateReleaseAlertState(
