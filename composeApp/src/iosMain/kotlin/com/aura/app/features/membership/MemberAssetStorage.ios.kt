package com.aura.app.features.membership
...
internal actual object MemberAssetStorage {
    ...
    private val backgroundDirectory = "${NSHomeDirectory()}/Library/Caches/AuraMemberBackgrounds"
    private val avatarDirectory = "${NSHomeDirectory()}/Library/Caches/AuraMemberAvatars"
    private val legacyBrandingPath = "${NSHomeDirectory()}/Library/Application Support/AuraMembership/branding.png"
