...
internal actual val usesNativeAuraBottomSheet: Boolean = true

private var activeNativeBottomSheet: UIViewController? = null
private var activeNativeBottomSheetDelegate: AuraNativeBottomSheetDelegate? = null
...
internal actual fun AuraNativeModalBottomSheet(
    ...
    val themeTokens = LocalAuraThemeTokens.current
    val typeScale = LocalAuraTypeScale.current
    ...
    DisposableEffect(parentViewController) {
        val contentController = ComposeUIViewController {
            CompositionLocalProvider(
                ...
                LocalAuraThemeTokens provides latestThemeTokens.value,
                LocalAuraTypeScale provides latestTypeScale.value,
                    ...
                    CompositionLocalProvider(
                        ...
                        Column(
                            modifier = latestModifier.value
                                ...
                                .padding(top = AuraTokens.Space.s20),
                        ) {
        ...
        val dismissalDelegate = AuraNativeBottomSheetDelegate {
...
internal actual fun dismissNativeAuraBottomSheet() {
    activeNativeBottomSheet?.dismissViewControllerAnimated(
        flag = true,
        completion = null,
    )
...
private class AuraNativeBottomSheetDelegate(
