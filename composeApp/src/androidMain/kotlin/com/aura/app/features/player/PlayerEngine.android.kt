...
import com.aura.app.features.streams.normalizeStreamType
...
private class NuvioLibmpvView(
    ...
    private var currentExternalSubtitles: List<com.aura.app.features.streams.StreamSubtitle> = emptyList()
    @Volatile
...
internal class SubtitleRequestHeaderDataSourceFactory(
    ...
    private val externalSubtitles: List<com.aura.app.features.streams.StreamSubtitle>,
) : DataSource.Factory {
